      ...
      (entries, obs) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const delay = [...items].indexOf(el) * 120;
    ...
    <main>
      ...
      <section className="nosotros">
        <div className="container">
          <h2>¿Qué hacemos?</h2>
          <p className="subtitulo">
            Combinamos diseño, tecnología y estrategia para crear sitios web
            que se vean bien, funcionen perfecto y representen tu marca con
            profesionalismo.
          </p>
        </div>
      </section>
